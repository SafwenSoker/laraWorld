    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input type="text" name="lastname" id="lastname" class="form-control" placeholder="Lastanme goes here">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col"><div class="form-group">
                ...
                <input type="text" name="phone" id="phone" class="form-control" placeholder="Phone number goes here">
            </div></div>
            <div class="col"> <div class="form-group">
